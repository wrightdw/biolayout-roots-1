 ...
 *
 * Updated to function from Roots version 8000e5c to take account of changes in WordPress 3.5
 */
...
function roots_gallery($attr) {
 ...
 // $output = '<div class="data-carousel-extra">'.$output.'</div>';
 ...
 */
 //filter no longer required in WordPress 3.6 - looks for search form in theme root directory - searchform.php moved up
/*
